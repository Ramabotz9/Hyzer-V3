...
global.reloadHandler = function (restatConn) {
  ...
  conn.bye = 'Byee beban! Jngan balik lagi ye,samping bertemu di lain GC'
  conn.spromote = '@user KENAPA LU HARUS JADI ADMIN SIH?'
  conn.sdemote = '@user KASIAN UDAH GA ADMIM'
